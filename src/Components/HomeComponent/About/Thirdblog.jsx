...
export default function Thirdblog() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-black font-contrail  overflow-hidden">
      ...
      {/* Footer */}
      <footer className="relative z-50 bg-white text-black py-16 text-center">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold mb-4">
            About Thirdvizion Technologies Pvt Ltd
          </h3>
          <p className="text-lg leading-relaxed">
            Thirdvizion Technologies Pvt Ltd is a forward-thinking company bringing
            together immersive technology, creativity, and innovation to transform
            digital experiences. We specialize in VR, AR, 3D, cloud, and development
            solutions to help businesses achieve the next level of impact.
          </p>
        </div>
        <Carousal/>
      </footer>
