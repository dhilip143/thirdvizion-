...
//             <h2 className="text-4xl sm:text-center md:text-5xl font-extrabold leading-tight bg-gradient-to-r from-indigo-400 to-violet-500 bg-clip-text text-transparent">
