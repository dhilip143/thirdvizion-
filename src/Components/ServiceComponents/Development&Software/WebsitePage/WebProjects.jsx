...
export default function WebProject() {
  ...
  return (
    <>
      ...
      >
        <TextReveal>
          <motion.h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl mt-60 font-extrabold font-inter-tight tracking-wide bg-gradient-to-r from-cyan-400 via-cyan-300 to-cyan-500 t bg-clip-text drop-shadow-[0_0_15px_rgba(34,211,238,0.4)]" style={{ fontFamily: "Outfit, sans-serif" }}>
            Our Portfolio
          </motion.h1>
        </TextReveal>
