    ...
    <div className="min-h-screen bg-black py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-extrabold text-transparent bg-gradient-to-r from-blue-500 via-cyan-400 to-green-400 bg-clip-text sm:text-6xl">
            Development Services
          </h1>
          <p className="mt-5 max-w-xl mx-auto text-lg text-gray-400">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div
              key={service.id}
              className={`relative rounded-3xl overflow-hidden backdrop-blur-xl bg-white/10 border border-white/20 shadow-[0_0_30px_rgba(255,255,255,0.08)] transition-all duration-500 hover:shadow-[0_0_50px_rgba(255,255,255,0.15)] hover:-translate-y-2`}
            >
              {/* Gradient Top Bar */}
              ...
              <div className="p-8">
                ...
                {/* Button */}
                <button className={`px-6 py-3 rounded-lg font-semibold text-white bg-gradient-to-r ${service.color} hover:opacity-90 transition-opacity shadow-md`}>
                  Learn More
                </button>
              </div>
