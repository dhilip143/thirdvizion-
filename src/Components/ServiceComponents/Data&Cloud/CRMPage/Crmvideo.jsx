    ...
    return (
        <section className="w-full min-h-screen text-white py-8 md:py-16 px-4 sm:px-6 font-sans">
            ...
            <div className="max-w-7xl mx-auto text-center mb-8 md:mb-16">
                <div className="inline-flex items-center gap-2 md:gap-3 px-4 md:px-6 py-2 md:py-3 rounded-full bg-gradient-to-r from-[#FF646710] to-[#FF8E9E10] border border-[#FF646730] mb-6 md:mb-8">
                    <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-[#FF6467] rounded-full animate-pulse"></div>
                    <span className="text-xs md:text-sm font-medium text-[#FF8E9E] font-sans" style={{ fontFamily: "Outfit, sans-serif" }}>CRM PLATFORM OVERVIEW</span>
                </div>
                <h1 className="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-medium mb-4 md:mb-6 font-sans">
            ...
            <div className="max-w-6xl mx-auto mb-12 md:mb-20">
                <div className="relative group">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-[#FF6467] to-[#FF8E9E] rounded-2xl md:rounded-3xl blur-2xl md:blur-3xl opacity-20 group-hover:opacity-30 transition-opacity duration-500 -z-10"></div>
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <button
                                    ...
                                    className={`group relative bg-gradient-to-r from-[#FF6467] to-[#FF8E9E] w-12 h-12 md:w-20 md:h-20 rounded-full flex items-center justify-center transform transition-all duration-300 hover:scale-110 hover:shadow-2xl ${isPlaying ? 'opacity-0 group-hover:opacity-100' : 'opacity-100'}`}
                                >
                            ...
                            <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-3 md:gap-0">
                                ...
                                <div className="flex gap-2 md:gap-3 self-end">
                                    ...
                                    <button 
                                        ...
                                        className="bg-white/10 backdrop-blur-sm rounded-lg md:rounded-xl p-2 md:p-3 border border-white/10 hover:bg-white/20 transition-all duration-300"
                                    >
                                    ...
                                    <button className="bg-white/10 backdrop-blur-sm rounded-lg md:rounded-xl p-2 md:p-3 border border-white/10 hover:bg-white/20 transition-all duration-300">
                                        <svg className="w-4 h-4 md:w-5 md:h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 border border-[#FF646730] hover:border-[#FF646760] transition-all duration-500">
                    <div className="flex items-center gap-3 md:gap-4 mb-6 md:mb-8">
                        <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-[#FF6467] to-[#FF8E9E] rounded-xl md:rounded-2xl flex items-center justify-center">
                            <span className="text-white text-lg md:text-xl">🎯</span>
                        </div>
                        <div>
                            <h3 className="text-xl md:text-2xl font-bold text-white font-sans" style={{ fontFamily: "Outfit, sans-serif" }}>Who Needs CRM?</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                        {[
                            ...
                            <div 
                                key={index}
                                className={`group flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-xl md:rounded-2xl bg-gradient-to-r from-gray-800/50 to-gray-700/30 border border-gray-700/50 hover:border-[#FF646760] hover:bg-gradient-to-r hover:from-gray-800/80 hover:to-gray-700/60 transition-all duration-300 ${
