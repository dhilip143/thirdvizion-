          ...
          <div className="max-w-2xl mx-auto lg:ml-0">
            ...
            <TextReveal>
              <motion.h1
                ...
                viewport={{ amount: 0 }}
                className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold leading-tight sm:leading-tight lg:leading-tight tracking-tight mb-4 lg:mb-6 text-[#FF6467]"
