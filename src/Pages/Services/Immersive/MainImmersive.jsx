...
const services = [
  {
    ...
    description: 'Transform your business operations with our cutting-edge virtual reality solutions designed for enterprise applications.',
    icon: '🏢',
    features: [
  ...
  },
  {
    ...
    description: 'Create unforgettable virtual experiences that engage customers and elevate your brand presence.',
    icon: '🌌',
    features: [
  ...
  },
  {
    ...
    description: 'From concept to deployment, our team builds custom VR applications tailored to your specific needs.',
    icon: '🛠️',
    features: [
...
const VirtualRealityServices = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white px-4 md:px-10 py-16 relative overflow-hidden" ref={containerRef}>
      {/* Background elements - Violet theme */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div ref={headerRef} className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            From groundbreaking simulations to captivating experiences, we build the virtual worlds of tomorrow.
          </p>
        </div>
          ...
          <div className="lg:sticky lg:top-8 self-start">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-4 text-violet-300 relative z-10">Key Features</h3>
        ...
        >
          {statsData.map((stat, index) => (
            ...
            >
              ...
              <div className="text-gray-300 mt-2 text-sm md:text-base relative z-10">{stat.label}</div>
            </motion.div>
          ))}
        </motion.div>
      </div>
...
export default VirtualRealityServices;