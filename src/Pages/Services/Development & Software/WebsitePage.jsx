import { FaReact, FaWordpress, FaPython, FaPhp } from "react-icons/fa";
import { SiExpress } from "react-icons/si";
import { motion } from "framer-motion";
import WebsiteGallery from "/src/Components/ServiceComponents/Development&Software/WebsiteGallery";
import WebStack from "/src/Components/ServiceComponents/Development&Software/WebStack";
      ...
      <section className="bg-black py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="bg-gradient-to-r from-yellow-400 via-green-400 to-blue-400 bg-clip-text text-transparent mb-12 max-w-3xl mx-auto text-lg leading-relaxed">
            At <span className="font-semibold">ThirdVizion</span>, we specialize
            in creating next-gen digital experiences. Our team blends design,
      ...
      <section className="h-screen w-full bg-gradient-to-b from-gray-900 via-black to-gray-900 flex flex-col items-center justify-center px-6">
        ...
        <div className="text-center max-w-3xl mb-16">
          ...
          <p className="mt-4 text-lg md:text-xl text-gray-300 leading-relaxed">
            The technologies we love and use to build lightning-fast, scalable,
