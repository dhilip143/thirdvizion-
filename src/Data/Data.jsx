...
import image1 from "/src/assets/HeroImage.jpg";
...
const BlogsData = [
  {
    ...
    HeroImage: image1,
    innerContent: [
      "Immersive technologies such as Virtual Reality (VR), Augmented Reality (AR), and Mixed Reality (MR) create engaging, interactive experiences. They allow users to step into digital worlds and interact in real time.",
      "Businesses are leveraging immersive tech for training, education, gaming, and marketing. This innovation bridges the gap between digital and physical spaces, creating opportunities worldwide."
    ],
