...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex justify-between items-center h-14 sm:h-16 md:h-18 px-4 md:px-8 lg:px-10">
          {/* Logo */}
          ...
          <nav className="hidden lg:flex justify-center items-center gap-6 xl:gap-8 text-white text-sm xl:text-base">
            ...
            <Link to="/blog" className="hover:text-purple-400">Resources</Link>
          </nav>
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div
                ...
                className="fixed top-0 right-0 w-full h-screen bg-black/95 backdrop-blur-lg z-40 flex flex-col p-6 overflow-y-auto"
              >
                {/* Mobile Nav */}
                <nav className="flex flex-col gap-5 text-white mt-14 text-lg">
                  <Link to="/" onClick={() => setIsOpen(false)} className="hover:text-purple-400">
                    Home
                  </Link>
                  <Link to="/about" onClick={() => setIsOpen(false)} className="hover:text-purple-400">
                    About
                  </Link>
                        ...
                        <div className="flex flex-col gap-2">
                          {categoryData.pages.map((page) => (
                            <button
                              key={page.name}
                              onClick={() => handleBoxClick(page)}
                              className="flex items-center gap-3 p-2 rounded-lg hover:bg-white/10 text-sm"
                            >
                              <span className="w-6 h-6 flex items-center justify-center rounded bg-white/10 text-purple-400">
                                {page.icon}
                              </span>
                  ...
                  <Link to="/contact" onClick={() => setIsOpen(false)} className="hover:text-purple-400">
                    Contact
                  </Link>
                  <Link to="/blog" onClick={() => setIsOpen(false)} className="hover:text-purple-400">
                    Resources
                  </Link>
